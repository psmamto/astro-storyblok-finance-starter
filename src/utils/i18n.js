...
const LANGUAGE_FLAGS = {
  ...
  pl: `<g clip-path="url(#a)"><rect width="22" height="16" x="-3" fill="#fff" rx="2"/><rect width="22" height="8" x="-3" y="8" fill="#DC143C" rx="0"/></g><defs><clipPath id="a"><rect width="22" height="16" x="-3" fill="#fff" rx="2"/></clipPath></defs>`
}
